...
# ANSI escape character that plywoodpirate.string.color uses.
EC = "\x1B"
...
class Format:
    def __init__(self, code: int):
        ...
        .. code-block:: python
            ...
            from plywoodpirate.string.color import Format
...
class Style:
    def __init__(self, *args: Tuple[Union[str, int, "Format"]], reset: bool = True):
        ...
        .. code-block:: python
            ...
            from plywoodpirate.string.color import Style, red
...
def supports_color() -> bool:  # pragma: no cover
    """Checks if platform's terminal has color support.
...
def strip_ansi(text: str) -> str:
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from plywoodpirate.string.color import strip_ansi, red
