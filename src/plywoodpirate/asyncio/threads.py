...
async def to_thread(func: Callable, *args, **kwargs) -> Awaitable:
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from plywoodpirate.asyncio.threads import to_thread
            import asyncio
            import time
...
def awaitable(func: Callable) -> Awaitable[Any]:
    ...
    leverages the :func:`plywoodpirate.asyncio.threads.to_thread` function.
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from plywoodpirate.asyncio.threads import awaitable
            import asyncio
            import time
