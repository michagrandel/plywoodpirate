...
class BaseDict(dict):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from plywoodpirate.collections.mapping import BaseDict
...
class BidirectionalDict(BaseDict):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from plywoodpirate.collections.mapping import BidirectionalDict
...
class ObjectDict(BaseDict):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from plywoodpirate.collections.mapping import ObjectDict
...
class OverloadedDict(BaseDict):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from plywoodpirate.collections.mapping import OverloadedDict
...
class UnderscoreAccessDict(BaseDict):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from plywoodpirate.collections.mapping import UnderscoreAccessDict
...
class FrozenDict(BaseDict):
    ...
    .. code-block:: python
        ...
        from plywoodpirate.collections.mapping import FrozenDict
...
class MultiEntryDict(BaseDict):
    ...
    .. code-block:: python
        ...
        from plywoodpirate.collections.mapping import MultiEntryDict
...
class ItemDict(BaseDict):
    """Dictionary composed of :py:class:`plywoodpirate.collections.item.Item` key and values.

    Example:

        .. code-block:: python

            from plywoodpirate.collections.mapping import ItemDict
